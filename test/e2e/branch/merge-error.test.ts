...
describe('E2E: Branch merge error handling', () => {
    ...
    test('Error when branch name is not provided for merge', () => {
        try {
            // Attempt to merge a branch without specifying a name
            execSync(`grm branch merge`, {
                cwd: PROJECT_DIR,
        ...
        // Ensure no branches are merged erroneously and main branch remains unchanged
        ...
        return git.branchLocal().then(branches => {
            // No additional branches or commits should have been merged
